...
const sendCompanyWelcomeEmail = async ({ email, fullName, companyName }) => {
  ...
  await sendEmail({
    to: email,
    subject: `Welcome to Tbuilds — ${companyName} is ready!`,
    html: `
      <div style="margin:0;background:#f4f5f7;padding:32px 16px;font-family:Arial,sans-serif;color:#172033;">
        <div style="max-width:620px;margin:0 auto;background:#fff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;">
          ...
          <div style="padding:32px;">
            ...
            <p style="color:#475569;font-size:14px;line-height:1.7;">Congratulations! <strong>${safeCompanyName}</strong> has been created successfully in Tbuilds.</p>
            ...
            <p style="text-align:center;margin:28px 0;"><a href="${appUrl}/personal" style="background:#07101f;color:#fff;padding:13px 24px;text-decoration:none;border-radius:8px;font-weight:600;display:inline-block;">Open Tbuilds</a></p>
